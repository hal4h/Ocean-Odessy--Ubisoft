...
void Obstacles::DrawObstacles(float yPos)
{
    ...
    for (CSimpleSprite *rockSprite : rockSprites)
    {
        ...
        rockSprite->SetPosition(currentX, currentY + yPos); // Add yPos to the current Y position, Set the updated position
...
void Obstacles::initializeSprites()
{
    ...
    {
        CSimpleSprite *yellowJellySprites = initYellowJelly();
        yellowJellySprites.push_back(tireSprite);
    }
